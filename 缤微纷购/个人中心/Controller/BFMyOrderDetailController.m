...
- (void)clickToOperateWithType:(BFOrderDetailBottomViewButtonType)type {
    switch (type) {
        case BFOrderDetailBottomViewButtonTypeCancleOrder:{
            ...
            UIAlertController *alertC = [UIAlertController alertWithControllerTitle:@"取消订单" controllerMessage:@"客官,真的要取消吗?请三思啊!" preferredStyle:UIAlertControllerStyleAlert cancleTitle:@"算了,不取消了!" actionTitle:@"下定决心,不要了!" style:UIAlertActionStyleDefault handler:^{
                //取消订单请求
                [self cancleOrder];
            }];
