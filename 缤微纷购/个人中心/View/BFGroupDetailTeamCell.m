...
- (void)setModel:(TeamList *)model {
    ...
    if (model) {
        if ([model.join isEqualToString:@"2"]) {
...
- (void)setCell {
    ...
    UIView *line = [UIView drawLineWithFrame:CGRectMake(BF_ScaleWidth(25), CGRectGetMaxY(self.bottomView.frame), 2, BF_ScaleHeight(20))];
