...
#define OrderDetailViewH    BF_ScaleHeight(175)
...
- (void)setModel:(BFGroupOrderDetailModel *)model {
    ...
    if (model) {
        ...
        self.productPrice.text = [NSString stringWithFormat:@"¥%@", model.team_price];
        [self layoutSubviews];
    }
}
...
- (void)setView {
    ...
    self.totalPrice = [self setUpLabelWithFrame:CGRectZero textColor:BFColor(0xD4001B) font:BF_ScaleFont(15) text:@"24.90"];
    ...
    self.productPrice = [self setUpLabelWithFrame:CGRectMake(BF_ScaleWidth(210), BF_ScaleHeight(56), BF_ScaleWidth(100), BF_ScaleHeight(20)) textColor:BFColor(0xD4001B) font:BF_ScaleFont(15) text:@"¥24.9/件"];
    ...
    checkGroupDetail.frame = CGRectMake(BF_ScaleWidth(210), CGRectGetMaxY(productView.frame)+BF_ScaleHeight(10), BF_ScaleWidth(90), BF_ScaleHeight(30));
