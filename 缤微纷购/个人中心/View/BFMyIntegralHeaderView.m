...
- (void)setView{
    ...
    UILabel *titleLabel = [UILabel labelWithFrame:CGRectMake(BF_ScaleWidth(10), 0, BF_ScaleWidth(90), HeaderH) font:BF_ScaleFont(12) textColor:BFColor(0x0F61BE) text:@"当前可用积分："];
    [self addSubview:titleLabel];
    
    self.integeralLabel = [UILabel labelWithFrame:CGRectMake(CGRectGetMaxX(titleLabel.frame), 0, BF_ScaleWidth(180), HeaderH) font:BF_ScaleFont(20) textColor:BFColor(0x0F61BE) text:@"1001"];
