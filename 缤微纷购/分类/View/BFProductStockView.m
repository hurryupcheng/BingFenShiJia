...
- (void)setModel:(BFProductDetialModel *)model {
    ...
    if (model) {
        ...
        UIView *seperateLine = [UIView drawLineWithFrame:CGRectMake(self.productOriginPrice.x, self.productOriginPrice.y + BF_ScaleHeight(7), self.productOriginPrice.width, 1)];
